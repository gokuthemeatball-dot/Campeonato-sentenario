...
const adminTranslations = {
  ...
  'Send sign-in link →': 'Enviar enlace de acceso →',
  'Approved registrations': 'Registros aprobados',
  'Verified money': 'Dinero verificado',
  'Pending payment reviews': 'Revisiones de pago pendientes',
  'PENDING PAYMENT CONFIRMATIONS': 'CONFIRMACIONES DE PAGO PENDIENTES',
  'Compare each Cash App confirmation with the payment received before accepting the registration.': 'Compara cada confirmación de Cash App con el pago recibido antes de aceptar el registro.',
  'No pending payment confirmations.': 'No hay confirmaciones de pago pendientes.',
  'Payment verified — accept registration': 'Pago verificado — aceptar registro',
  'Payment not verified — reject registration': 'Pago no verificado — rechazar registro',
  'TEST MODE': 'MODO DE PRUEBA',
  'Test registrations are separate and never count as official players.': 'Los registros de prueba están separados y nunca cuentan como jugadores oficiales.',
  'Enable Test Mode': 'Activar modo de prueba',
  'Tester access code': 'Código de acceso para probadores',
  'Save Test Mode': 'Guardar modo de prueba',
  'Clear test registrations': 'Borrar registros de prueba',
  'Tester link:': 'Enlace para probadores:',
  'TEST REGISTRATIONS': 'REGISTROS DE PRUEBA',
  'No test registrations.': 'No hay registros de prueba.',
  'PLAYER REGISTRATIONS': 'REGISTROS DE JUGADORES',
  'PLAYER QUESTIONS': 'PREGUNTAS DE LOS JUGADORES',
  'Questions sent from the public website.': 'Preguntas enviadas desde el sitio público.',
  'No questions yet.': 'Aún no hay preguntas.',
  'Delete question': 'Eliminar pregunta',
  'Organizer reply': 'Respuesta del organizador',
  'Save and publish reply': 'Guardar y publicar respuesta',
