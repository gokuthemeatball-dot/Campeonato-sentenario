...
const adminTranslations = {
  ...
  'Pending meeting requests': 'Solicitudes pendientes de la reunión',
  'PENDING MEETING REGISTRATIONS': 'REGISTROS PENDIENTES DE LA REUNIÓN',
  'Select a person after asking for their name at the meeting.': 'Selecciona a la persona después de preguntarle su nombre en la reunión.',
  'No pending meeting registrations.': 'No hay registros pendientes de la reunión.',
  'Payment received — accept registration': 'Pago recibido — aceptar registro',
  'Payment not received — revoke request': 'Pago no recibido — revocar solicitud',
